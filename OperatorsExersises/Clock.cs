...
/*
  Є клас годинник (Година, Хвилина, Секунда - проперті)
Є таймер (Хвилини, Секунди, Мілісекунди)
Для класу годинника перевантажити оператори <, >, <=, >=, ==, !=
Те саме для таймера.
Перевантажити оператори для операцій Годинник - Таймер і Годинник + Таймер (результатом має бути годинник зі зміненим відповідно часом, мілісекунди таймера заокруглюємо)*/
